...
class ComposerAutoloaderInit5960512d55e7d355167b2b28c2b88105
{
    ...
    public static function getLoader() //获取加载
    {
        ...
        spl_autoload_register(['ComposerAutoloaderInit5960512d55e7d355167b2b28c2b88105', 'loadClassLoader'], true, true); //类制动加载注册,自动调用array中的函数 throw抛出错误   prepend如果是 true，spl_autoload_register() 会添加函数到队列之首，而不是队列尾部。
        self::$loader = $loader = new \Composer\Autoload\ClassLoader(); //加载类,php本身调用此时调用了之前注册的,调用时会将需要实例化的 完整命名空间 + 类名传入
        spl_autoload_unregister(['ComposerAutoloaderInit5960512d55e7d355167b2b28c2b88105', 'loadClassLoader']); //删除之前注册的
        ...
        if ($useStaticLoader) {
            ...
            //将 composer cli 生成的各种 autoload_psr4, autoload_classmap, autoload_namespaces(psr-0) 全都注册到 Composer\ClassLoader 中
            $map = require __DIR__ . '/autoload_namespaces.php'; //文件数组
            foreach ($map as $namespace => $path) {
                $loader->set($namespace, $path);
            }

            $map = require __DIR__ . '/autoload_psr4.php'; //psr4文件数组
            foreach ($map as $namespace => $path) {   //遍历加载psr4
                $loader->setPsr4($namespace, $path);
            }

            $classMap = require __DIR__ . '/autoload_classmap.php'; //文件数组
            if ($classMap) {
        ...
        if ($useStaticLoader) {
            ...
            //直接 require 所有在 autoload_files 中的文件 全局的 helper function
